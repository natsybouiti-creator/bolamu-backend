...
⚠️ **OBSOLÈTE / HORS-PÉRIMÈTRE** — Ce scénario ne fait pas partie du modèle Bolamu actuel (SSP gratuit / hors-catalogue payé plein tarif). Le mécanisme tiers-payant a été abandonné. Le code backend existe encore dans `src/controllers/tiers-payant.controller.js` mais n'est pas utilisé en production.
