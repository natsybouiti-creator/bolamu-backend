...
> **SUPERSEDED — Ce document est invalide pour deux raisons :**
> **1. Nommage des paliers Bronze/Argent/Or/Platine abandonné (remplacé par Kimia/Liboso/Nkembo/Elonga en Lingala).**
> **2. Mécanisme de retrait cash MoMo abandonné pour raison réglementaire (pas d'agrément BEAC). Voir ARCHITECTURE_ZORA_BOLAMU.md v1.1.**
