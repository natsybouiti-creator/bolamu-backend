...
// ─── ALIAS COLLECTE (OVP/SEPA) — DÉPRÉCIÉ ────────────────────────────────────
// DOUBLON de GET /ovp/pending et GET /sepa/pending définis plus haut (lignes 646/664).
// Express retient la PREMIÈRE définition : ce bloc n'est jamais atteint (code mort).
// Le frontend admin/dashboard.html appelle /api/v1/admin/ovp/pending (première définition).
// Conservé en commentaire pour traçabilité — ne pas réactiver.
// router.get('/ovp/pending', authMiddleware, adminOnly, async (req, res) => {
//   try {
//     const result = await pool.query(
//       `SELECT
