...
| 13 | `/ai-specialist` | Amina · Claude · IA santé | P1 |
...
### /ai-specialist — Amina · Claude · IA santé
**Mission :** Agent Amina (Anthropic Claude), briefing pre-consultation, feu tricolore, renouvellement.
**Périmètre :** src/services/amina.service.js, src/services/ai-consult.service.js.
**Stack IA :** Anthropic Claude (principal) + Google Gemini + Groq (fallback coût).
